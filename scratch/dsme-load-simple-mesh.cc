...
#define NUM_RFD 2 // The number of RFD.
 ...
 void SendIPv6Packet(Ptr<SixLowPanNetDevice> dev, Mac48Address dstMac)
 {
...
//  }
 ...
 int main(int argc, char** argv) {
     ...
     {
        Ptr<SixLowPanNetDevice> dev = sixlowDevices.Get(i)->GetObject<SixLowPanNetDevice>();
        Simulator::Schedule(Seconds(1.141185), &SixLowPanNetDevice::PrintLoadTable, dev);
     }

     Ptr<SixLowPanNetDevice> dev0 = sixlowDevices.Get(3)->GetObject<SixLowPanNetDevice>();  // sender
     Ptr<SixLowPanNetDevice> dev1 = sixlowDevices.Get(4)->GetObject<SixLowPanNetDevice>();  // receiver
