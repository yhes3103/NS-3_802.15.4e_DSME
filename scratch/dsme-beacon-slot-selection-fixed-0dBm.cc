/*
 * DSME beacon slot selection — Fixed 0 dBm baseline (random topology)
 ...
 *   P_tx_avg — 平均發送功率 (fixed 0 dBm / 1 mW)
 */
...
static void PrintSummary(uint32_t numNodes)
{
  ...
  NS_LOG_UNCOND("==== Beacon Slot Selection Summary (Fixed 0 dBm) ====");
